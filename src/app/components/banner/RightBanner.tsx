  ...
  return (
    <div className="w-full lgl:w-1/2 xl:w-1/2 flex justify-center items-center relative">
      <Image
        ...
        className={`w-[300px] h-[350px] lgl:w-[500px] xl:w-[600px] lgl:h-[500px] xl:h-[500px] z-10 object-cover ${
          loaded ? "blur-none" : "blur-sm"
        } `}
      />
      <div className="absolute bottom-0 w-[300px] h-[300px] lgl:w-[480px] lgl:h-[450px] bg-gradient-to-r from-[#1e2024] to-[#202327] shadow-shadowOne flex justify-center items-center"></div>
    </div>
  );
};
